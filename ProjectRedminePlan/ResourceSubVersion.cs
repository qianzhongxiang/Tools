...
{
    public class ResourceSubVersion
    {
        ...
        public ResourceSubVersion(MSProjectWrapper mSProjectWrapper, Redmine.Net.Api.Types.Version version, RedmineProvider redmineProvider)
        {
        ...
        public async Task UpdateTasks()
        {
            ...
            if (issues != null)
            {
                ...
                //    foreach (Microsoft.Office.Interop.MSProject.Task item in MainTask.OutlineChildren)
                //    {
